...
* 그리고 싶은 그림을 자유롭게 그리기
* 그리고, 그림을 똑같이 그릴 수 있는 설명하는 글 쓰기
  - 말하고 그리기 활동에서 설명하는 말을 글로 바꾸는 것과 같음
...
* 엉뚱한 결과물(전혀 다른 경우)이 나온 경우 (별점 1)
  - 구성 요소가 포함되어 있지만 전혀 다른 완성물인 경우
  - 각자 생각하는 개념 표현의 차이  
...
_class: lead
-->
![bg left:30%](https://upload.wikimedia.org/wikipedia/commons/c/c8/ANWhitehead.jpg)

"좋은 **표기법**은 두뇌에서 불필요한 작업을 덜어내어, 두뇌가 더 고차원적인 문제에 집중할 수 있는 자유를 준다."
